...
export default function Me() {
  ...
  return <AuthFrame title={profile.name}>
    ...
    <Link href="/explore" asChild><Button label="Explore opportunities" variant="secondary" /></Link><Link href="/messages" asChild><Button label="Messages" variant="secondary" /></Link><MyOrganizations />{profile.role === "sponsor" ? <Text className={textStyle}>To create a Call for Events, open an organization you administer. If you have none, create an organization first.</Text> : null}
